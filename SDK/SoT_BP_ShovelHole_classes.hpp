...
public:
	...
	class UDecalComponent*                             DirtDecal;                                                // 0x0488(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class UStaticMeshComponent*                        DirtPile;                                                 // 0x0490(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
