...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BP_CollectorsChest_RevengeOfTheMorningstar_Proxy.BP_CollectorsChest_RevengeOfTheMorningstar_Proxy_C");
		return ptr;
	}
