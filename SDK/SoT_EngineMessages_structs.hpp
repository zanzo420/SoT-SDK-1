...
{
	struct FString                                     UserName;                                                 // 0x0000(0x0010) (ZeroConstructor)
	struct FString                                     UserToGrant;                                              // 0x0010(0x0010) (ZeroConstructor)
};
...
{
	struct FString                                     UserName;                                                 // 0x0000(0x0010) (ZeroConstructor)
	struct FString                                     UserToDeny;                                               // 0x0010(0x0010) (ZeroConstructor)
};
...
struct FEngineServicePong
{
	...
	struct FString                                     InstanceType;                                             // 0x0028(0x0010) (ZeroConstructor)
