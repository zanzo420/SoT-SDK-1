...
public:
	...
	class UStaticMeshComponent*                        shp_flag_jolly_roger_01_a;                                // 0x0A40(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	...
	class UStaticMeshComponent*                        shp_small_mast_bell_support_01_a;                         // 0x0A70(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class UChildActorComponent*                        BP_Bell1;                                                 // 0x0A78(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
