...
// 0x0008 (0x14A0 - 0x1498)
class ABP_OnlineAthenaPlayerController_C : public AOnlineAthenaPlayerController
{
public:
	class UBP_Component_Tutorial2019_C*                VisitShopkeepersTutorialComponent;                        // 0x1498(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
