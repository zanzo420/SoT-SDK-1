...
void UBP_Anim_Blunderbuss_C::OnOneShotUseTriggered(class UClass** InputID, struct FWieldableItemActionVisuals* ActionVisuals)
{
...
void UBP_Anim_Blunderbuss_C::OnUseStarted(class UClass** InputID, struct FWieldableItemActionVisuals* ActionVisuals)
{
