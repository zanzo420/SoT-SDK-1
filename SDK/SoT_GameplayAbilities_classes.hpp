...
public:
	...
	struct FString                                     GlobalCurveTableName;                                     // 0x0088(0x0010) (ZeroConstructor, Config)
	struct FString                                     GlobalAttributeMetaDataTableName;                         // 0x0098(0x0010) (ZeroConstructor, Config)
	struct FString                                     GlobalAttributeSetDefaultsTableName;                      // 0x00A8(0x0010) (ZeroConstructor, Config)
