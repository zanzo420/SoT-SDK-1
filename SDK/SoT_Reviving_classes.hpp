...
public:
	...
	TArray<class UMaterialInstanceDynamic*>            CorpseMaterials;                                          // 0x0420(0x0010) (ZeroConstructor)
	class USceneComponent*                             Root;                                                     // 0x0430(0x0008) (Edit, ExportObject, ZeroConstructor, DisableEditOnInstance, EditConst, InstancedReference, IsPlainOldData)
	...
	class USceneComponent*                             AstralCordContainer;                                      // 0x0440(0x0008) (Edit, ExportObject, ZeroConstructor, DisableEditOnInstance, EditConst, InstancedReference, IsPlainOldData)
	class UAnimationDataStoreComponent*                AnimationDataStoreComponent;                              // 0x0448(0x0008) (Edit, ExportObject, ZeroConstructor, DisableEditOnInstance, EditConst, InstancedReference, IsPlainOldData)
	class UPostProcessComponent*                       PostProcessComponent;                                     // 0x0450(0x0008) (Edit, ExportObject, ZeroConstructor, DisableEditOnInstance, EditConst, InstancedReference, IsPlainOldData)
	class UDitherComponent*                            DitherComponent;                                          // 0x0458(0x0008) (Edit, ExportObject, ZeroConstructor, DisableEditOnInstance, EditConst, InstancedReference, IsPlainOldData)
	class UReviveAudioComponent*                       AudioComponent;                                           // 0x0460(0x0008) (Edit, ExportObject, ZeroConstructor, DisableEditOnInstance, EditConst, InstancedReference, IsPlainOldData)
	unsigned char                                      UnknownData01[0x10];                                      // 0x0468(0x0010) MISSED OFFSET
	TEnumAsByte<ENetRole>                              RevivableOwnerNetRole;                                    // 0x0478(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0x7];                                       // 0x0479(0x0007) MISSED OFFSET
	class UGhostDataAsset*                             ReviveGhostDataAsset;                                     // 0x0480(0x0008) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	class UReviveEffectsDataAsset*                     ReviveEffectsDataAsset;                                   // 0x0488(0x0008) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	struct FReviveEffectsValues                        ReviveEffectsValues;                                      // 0x0490(0x0020)
	struct FModeSpecificReviveSettings                 ReviveSettings;                                           // 0x04B0(0x0030)
	unsigned char                                      UnknownData03[0x13C];                                     // 0x04E0(0x013C) MISSED OFFSET
	TWeakObjectPtr<class UParticleSystemComponent>     ContinuousOnTheBodyLoopingVFX;                            // 0x061C(0x0008) (ExportObject, ZeroConstructor, Transient, InstancedReference, IsPlainOldData)
	TWeakObjectPtr<class UParticleSystemComponent>     ReviveInProgressLoopingVFX;                               // 0x0624(0x0008) (ExportObject, ZeroConstructor, Transient, InstancedReference, IsPlainOldData)
	unsigned char                                      UnknownData04[0x1C];                                      // 0x062C(0x001C) MISSED OFFSET
	TArray<class UMaterialInstanceDynamic*>            AstralCordDynamicMaterials;                               // 0x0648(0x0010) (ZeroConstructor, Transient)
	struct FGhostPlayModeParameters                    GhostPlayModeSpecificParameters;                          // 0x0658(0x000C) (Transient)
