...
void UObjectMessagingFunctions::STATIC_RegisterEventFromHandle(class UObject* FunctionOwner, const struct FString& FunctionName, class UStruct* EventType, struct FObjectMessagingDispatcherHandle* MessageDispatcher, struct FObjectMessagingHandle* Handle)
{
...
void UObjectMessagingFunctions::STATIC_RegisterEvent(class UObject* FunctionOwner, const struct FString& FunctionName, class UStruct* EventType, struct FObjectMessagingDispatcher* MessageDispatcher, struct FObjectMessagingHandle* Handle)
{
...
// struct FString                 Scope                          (Parm, ZeroConstructor)
// struct FString                 ScopeId                        (Parm, ZeroConstructor)
// struct FGenericStruct          Value                          (Parm, OutParm, ZeroConstructor, ReferenceParm, IsPlainOldData)

void UObjectMessagingFunctions::STATIC_FireEventWithDataFromHandle(class UStruct* EventDataStruct, const struct FString& Scope, const struct FString& ScopeId, struct FObjectMessagingDispatcherHandle* MessageDispatcher, struct FGenericStruct* Value)
{
...
void UObjectMessagingFunctions::STATIC_FireEventWithData(class UStruct* EventDataStruct, const struct FString& Scope, const struct FString& ScopeId, struct FObjectMessagingDispatcher* MessageDispatcher, struct FGenericStruct* Value)
{
