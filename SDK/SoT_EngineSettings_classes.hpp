...
{
public:
	struct FString                                     EditorStartupMap;                                         // 0x0028(0x0010) (Edit, ZeroConstructor, Config)
	struct FString                                     LocalMapOptions;                                          // 0x0038(0x0010) (Edit, ZeroConstructor, Config)
	struct FString                                     TransitionMap;                                            // 0x0048(0x0010) (Edit, ZeroConstructor, Config)
	...
	struct FString                                     GameDefaultMap;                                           // 0x0070(0x0010) (Edit, ZeroConstructor, Config)
	struct FString                                     ServerDefaultMap;                                         // 0x0080(0x0010) (Edit, ZeroConstructor, Config)
