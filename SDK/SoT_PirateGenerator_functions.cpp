...
bool UPirateBodyShapeFunctionLibrary::STATIC_FindBodyBlendsFromBodyShapeWheelRadialCoordinate(TEnumAsByte<EIPGGender> Gender, const struct FRadialCoordinate& BodyShapeWheelRadialCoordinate, float* BaseMeshBlendWeight, TArray<struct FString>* BodyShapeBlendNames, TArray<float>* BodyShapeBlendWeights)
{
...
// (Final, Native, Static, Public, HasOutParms, BlueprintCallable)
// Parameters:
// struct FString                 RelativePath                   (Parm, ZeroConstructor)
...
// (Final, Native, Static, Public, BlueprintCallable, BlueprintPure)
// Parameters:
// struct FString                 RefName                        (Parm, ZeroConstructor)
...
// struct FString                 MeshTypeSkeletonFileFormat     (Parm, ZeroConstructor)
// float                          BaseMeshBlendWeight            (ConstParm, Parm, ZeroConstructor, IsPlainOldData)
// TArray<struct FString>         BodyShapeBlendNames            (ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm)
// TArray<float>                  BodyShapeBlendWeights          (ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm)
...
TArray<struct FName> UWardrobeFunctionLibrary::STATIC_GetAllWardrobeItemsForType(const struct FString& TypeName, TEnumAsByte<EIPGPirateType> PirateType, bool bWithExclusions)
{
