...
public:
	...
	class UCapsuleComponent*                           PlayerHits;                                               // 0x09D0(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class USkeletalMeshComponent*                      SkeletalMesh;                                             // 0x09D8(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class UCapsuleComponent*                           WorldHits;                                                // 0x09E0(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
