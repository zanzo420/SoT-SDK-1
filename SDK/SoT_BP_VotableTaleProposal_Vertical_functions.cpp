...
void ABP_VotableTaleProposal_Vertical_C::OnVoteAdded(TScriptInterface<class UVoterInterface>* Voter)
{
...
void ABP_VotableTaleProposal_Vertical_C::OnVoteRemoved(TScriptInterface<class UVoterInterface>* Voter)
{
