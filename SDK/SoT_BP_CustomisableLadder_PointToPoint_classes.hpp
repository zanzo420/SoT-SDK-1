...
public:
	...
	float                                              Ladder_Roll;                                              // 0x0680(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	struct FVector                                     Ladder_Top_Target;                                        // 0x0684(0x000C) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	struct FVector                                     Ladder_Bottom_Target;                                     // 0x0690(0x000C) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
