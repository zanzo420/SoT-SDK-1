...
{
public:
	class UBoxComponent*                               WaterInteractionOverlap;                                  // 0x08F0(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class UMaterialManipulationComponent*              MaterialManipulation;                                     // 0x08F8(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
