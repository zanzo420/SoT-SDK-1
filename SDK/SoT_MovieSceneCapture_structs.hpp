...
struct FMovieSceneCaptureSettings
{
	...
	struct FString                                     OutputFormat;                                             // 0x0010(0x0010) (Edit, ZeroConstructor, Config)
	...
	struct FString                                     Codec;                                                    // 0x0038(0x0010) (Edit, ZeroConstructor, Config)
