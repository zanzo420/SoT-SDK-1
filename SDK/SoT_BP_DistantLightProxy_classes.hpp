...
public:
	...
	class UInstancedStaticMeshComponent*               InstancedStaticMesh;                                      // 0x0418(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class USceneComponent*                             DefaultSceneRoot;                                         // 0x0420(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	TArray<struct FPointLightProxy>                    LightList;                                                // 0x0428(0x0010) (Edit, BlueprintVisible, ZeroConstructor)
