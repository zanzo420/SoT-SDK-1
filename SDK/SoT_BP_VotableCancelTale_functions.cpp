...
void ABP_VotableCancelTale_C::OnVoteAdded(TScriptInterface<class UVoterInterface>* Voter)
{
...
void ABP_VotableCancelTale_C::OnVoteRemoved(TScriptInterface<class UVoterInterface>* Voter)
{
