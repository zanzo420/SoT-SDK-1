...
struct FBPVariableDescription
{
	...
	struct FString                                     DefaultValue;                                             // 0x00D0(0x0010) (Edit, ZeroConstructor)
};
...
struct FEdGraphSchemaAction
{
	...
	struct FString                                     TooltipDescription;                                       // 0x0040(0x0010) (ZeroConstructor)
...
{
	struct FString                                     Stage;                                                    // 0x0000(0x0010) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor)
};
