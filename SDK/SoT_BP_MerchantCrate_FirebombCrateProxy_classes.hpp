...
// BlueprintGeneratedClass BP_MerchantCrate_FirebombCrateProxy.BP_MerchantCrate_FirebombCrateProxy_C
// 0x0018 (0x07E0 - 0x07C8)
class ABP_MerchantCrate_FirebombCrateProxy_C : public AStaticMerchantCrateItemProxy
{
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BP_MerchantCrate_FirebombCrateProxy.BP_MerchantCrate_FirebombCrateProxy_C");
		return ptr;
	}
