...
struct FSessionServicePong
{
	...
	struct FString                                     InstanceName;                                             // 0x0030(0x0010) (ZeroConstructor)
	bool                                               IsConsoleBuild;                                           // 0x0040(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x7];                                       // 0x0041(0x0007) MISSED OFFSET
	struct FString                                     PlatformName;                                             // 0x0048(0x0010) (ZeroConstructor)
	struct FGuid                                       SessionId;                                                // 0x0058(0x0010) (ZeroConstructor, IsPlainOldData)
	struct FString                                     SessionName;                                              // 0x0068(0x0010) (ZeroConstructor)
	struct FString                                     SessionOwner;                                             // 0x0078(0x0010) (ZeroConstructor)
