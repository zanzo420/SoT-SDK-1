...
public:
	...
	TEnumAsByte<EBeaconConnectionState>                ConnectionState;                                          // 0x0448(0x0001) (ZeroConstructor, IsPlainOldData)
...
public:
	...
	struct FString                                     DestSessionId;                                            // 0x0470(0x0010) (ZeroConstructor)
	struct FPartyReservation                           PendingReservation;                                       // 0x0480(0x0030)
	TEnumAsByte<EClientRequestType>                    RequestType;                                              // 0x04B0(0x0001) (ZeroConstructor, IsPlainOldData)
	bool                                               bPendingReservationSent;                                  // 0x04B1(0x0001) (ZeroConstructor, IsPlainOldData)
	bool                                               bCancelReservation;                                       // 0x04B2(0x0001) (ZeroConstructor, IsPlainOldData)
...
public:
	...
	unsigned char                                      UnknownData00[0x28];                                      // 0x0440(0x0028) MISSED OFFSET
	float                                              SessionTimeoutSecs;                                       // 0x0468(0x0004) (ZeroConstructor, Transient, Config, IsPlainOldData)
	float                                              TravelSessionTimeoutSecs;                                 // 0x046C(0x0004) (ZeroConstructor, Transient, Config, IsPlainOldData)
